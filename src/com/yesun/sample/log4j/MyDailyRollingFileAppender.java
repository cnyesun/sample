...
public class MyDailyRollingFileAppender extends FileAppender {
  ...
  */
  ...
  //传入userid，需要针对用户输出独立日志 by yesun 20120112
  ...
  /**
    ...
    */
  public MyDailyRollingFileAppender (String userid, String appid, Layout layout, String filename,
...
//    File target  = new File(this.userid + this.appid + scheduledFilename);
