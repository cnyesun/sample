...
public class RndImgFilter {
	BufferedImage image;
	private int iw, ih;
	private int[] pixels;

	public RndImgFilter(BufferedImage image) {
		this.image = image;
		iw = image.getWidth();
		ih = image.getHeight();
	...
	public static void main(String[] args) throws IOException {
		FileInputStream fin = new FileInputStream("c:\\rnd.bmp");
		BufferedImage bi = ImageIO.read(fin);
		RndImgFilter flt = new RndImgFilter(bi);
		flt.changeGrey();
		flt.getGrey();
		flt.getBrighten();
		bi = flt.getProcessedImg();

		File file = new File( "c:\\rnd-new.jpg");
